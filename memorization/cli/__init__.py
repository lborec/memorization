...
def parse_args():
    # PARSER OBJECT
    parser = ArgumentParser(description="Arg parser", formatter_class=RawTextHelpFormatter, usage=SUPPRESS)
    subparsers = parser.add_subparsers(dest='command')
    subparsers.required = True

    # SAMPLE ARGS
    sample_parser = subparsers.add_parser('sample')
    sample_parser.add_argument('--project_path', type=str,
    ...
    finetune_parser.add_argument('--model_version', type=str,
